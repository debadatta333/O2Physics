...
struct TableMaker {
  ...
  // Central barrel multiplicity estimation with the muon+mft DQ skimmed data model typically for pp/p-Pb or UPC Pb-Pb (no centrality), meant to run on skimmed data
